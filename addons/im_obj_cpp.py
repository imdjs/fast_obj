...
"""
try:
    from PYLIB.PYLIB_mesh import 十点线面卩;
except:
    if(G.文件夹此IOOBJ+".PYLIB_"+G.文件夹此IOOBJ+".PYLIB_"+G.文件夹此IOOBJ not in sys.modules):
        exec("from  "+".PYLIB_"+G.文件夹此IOOBJ+".PYLIB_"+G.文件夹此IOOBJ+"  import 十点线面卩");
"""
...
try:
    ...
    if(G.文件夹此IOOBJ+".PYLIB_"+G.文件夹此IOOBJ+".PYLIB_"+G.文件夹此IOOBJ not in sys.modules):
        exec("from  "+".PYLIB_"+G.文件夹此IOOBJ+".PYLIB_"+G.文件夹此IOOBJ+"  import*");
#======================================================
